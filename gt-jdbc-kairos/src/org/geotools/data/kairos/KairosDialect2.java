...
public class KairosDialect2 extends BasicSQLDialect {
    ...
    static final Version V_5_5_1 = new Version("5.0.0");

    public KairosDialect2(JDBCDataStore dataStore) {
        super(dataStore);
    }
    ...
    boolean supportsGeography(Connection cx) throws SQLException {
        return getVersion(cx).compareTo(V_5_5_1) >= 0;
    }
